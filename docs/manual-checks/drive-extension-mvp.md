...
9. Prepare a test vault folder that is inside the app's `drive.file` access boundary, then copy its Drive folder URL or folder id for the MV3-compatible folder prompt.
...
5. Enter the test Drive folder URL or folder id in the folder prompt.
6. Open `Home.md`.
