...
- Keeping `drive.file` as the only scope for an existing folder vault. It does not grant blanket recursive access to arbitrary descendants of a selected folder.
